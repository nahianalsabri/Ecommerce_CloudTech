...
const SignupSeller = () => {
  ...
  const continueSignin = async () => {
    if (view === "signup") {
      ...
      if (
        setIsValidEmail &&
        setPasswordConsistency &&
        !setIfAnyEmpty &&
        setIsCheckedCorrectness
      ) {
        ...
        const isRegisterd = await postInformationToBackend(
          "register",
          "seller",
      ...
      const isVarifide = await postInformationToBackend(
        "email_verify",
        "seller",
        data
      );
        ...
        <div className="loginsignup">
          <div className="loginsignup-container">
            ...
            <p className="loginsignup-login">
              ...
              <span>
                <Link to={"/login_seller"}>Login here</Link>
              </span>
            </p>
