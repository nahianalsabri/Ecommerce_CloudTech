...
import {
  getInformationToBackend,
  postInformationToBackend,
...
const Resetpassword = () => {
  ...
  const continueLogin = async () => {
    ...
    const setIsValidOTP = await postInformationToBackend(
      "resetPWD",
      role,
    ...
    const setPasswordConsistency =
      formValues.userPassword === formValues.userPasswordReapt;
    const setIfAnyEmpty =
      formValues.OTPcode.trim() === "" ||
      ...
      <div className="loginsignup-container">
        <div className="loginsignup-fields">
          ...
          <input
            ...
            onChange={(event) => handleChange("OTPcode", event)}
            placeholder="OTP code"
          />
          {!inputCorrectnessCheck.isValidOTP && (
            <p style={{ color: "red" }}>Invalid OTP, please check again</p>
          )}
          ...
          <input
            type="password"
            value={formValues.userPasswordReapt}
            onChange={(event) => handleChange("userPasswordReapt", event)}
